  ...
  (
    ...
    <DialogPortal>
      ...
      >
        ...
        <div className="absolute right-4 top-4 flex items-center justify-center gap-1 p-0 opacity-70 ring-offset-background focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
          {showMinimizeBtn && (
            <div
              onClick={onMinimize}
              className="rounded-sm border transition-opacity hover:opacity-100"
            >
          ...
          <DialogPrimitive.Close className="m-0 rounded-sm border outline-none transition-opacity hover:opacity-100">
